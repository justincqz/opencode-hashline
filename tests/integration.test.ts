...
describe('Integration: Full roundtrip read → hashify → edit → verify', () => {
    ...
    test('2. Multi-edit roundtrip', async () => {
        ...
        const line8Index = newLines.indexOf('line 8');
    ...
    test('4. Read → edit → re-read → edit again', async () => {
        ...
        const tag4 = extractTag(hashified, 4);
    ...
    test('5. LLM-copied prefixes in replacement content', async () => {
        ...
        const replacementWithPrefixes = [`1#0a1b:new content`, `2#c3d4:more content`];
...
2: const y = 2;
        ...
        const chatInput = { sessionID: 'test-session', model: mockModel };
        const chatOutput = {
